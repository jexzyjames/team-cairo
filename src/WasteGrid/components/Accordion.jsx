...
const Accordion = () => {
  const data = [
    {
      ...
      content:
        "WasteGrid is a mobile app that he;ps you sort waste correctly, learn about recycling, and earn rewards like airtime and vouchers for taking eco-friendly actions..",
    },
    {
    ...
    },
    {
      ...
      content:
        "React uses a virtual DOM and diffing algorithm for efficient rendering.",
    },
    {
  ...
  return (
    <div className=" md:mt-10 w-full  p-6">
      <h1 className="md:text-3xl text-xl md:mt-20 font-bold text-center mb-6">
