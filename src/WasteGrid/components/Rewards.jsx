...
const Rewards = () => {
  return (
    <div id='rewards' className='md:w-full md:flex mx-[5%] rounded-lg md:rounded-none mt-9 md:mx-auto relative gap-15 justify-between md:px-[3%] py-6 md:px-[1%]  items-center bg-[#99999964] '>
        <h1 className='absolute flex pt-6 font-bold mx-auto left-[35%] md:left-[40%]  items-center justify-center text-center text-2xl top-0  '>Rewards</h1>
       <div className=' px-3 md:mt-0 mt-25 w-full '>
        <h1 className='text-amber-800 text-4xl font-bold'>Clean Streets.</h1>
        <h1 className='text-amber-900 text-4xl mb-4 font-bold'>Full Pockets.</h1>
        <p className=' md:text-2xl mb-3'>WasteGrid turns your recycliing journey into real value. Stack coins, unlock perks, and give back to your community - all from the app.</p>
        <button className='bg-[#34C759] md:mb-0 mb-10  flex md:justify-start items-start  cursor-pointer px-10 text-2xl py-[5px]    rounded-4xl md:py-1 md:px-5 text-white shadow-sm '>Get Started</button>
       </div >
